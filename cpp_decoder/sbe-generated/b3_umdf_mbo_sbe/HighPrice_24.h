...
#ifndef _B3_UMDF_MBO_SBE_HIGHPRICE_24_CXX_H_
#define _B3_UMDF_MBO_SBE_HIGHPRICE_24_CXX_H_
...
public:
    ...
    HighPrice_24(char *buffer, const std::uint64_t bufferLength) :
        HighPrice_24(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    HighPrice_24(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        HighPrice_24(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    HighPrice_24 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    HighPrice_24 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        HighPrice_24 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    HighPrice_24 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    HighPrice_24 &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
    ...
    {
        return MDEntryType::Value::SESSION_HIGH_PRICE;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::SESSION_HIGH_PRICE);
    }
    ...
    HighPrice_24 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    HighPrice_24 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const HighPrice_24 &_writer)
{
    HighPrice_24 writer(
        _writer.m_buffer,
        _writer.m_offset,
