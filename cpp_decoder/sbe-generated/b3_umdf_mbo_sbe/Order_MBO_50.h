...
#ifndef _B3_UMDF_MBO_SBE_ORDER_MBO_50_CXX_H_
#define _B3_UMDF_MBO_SBE_ORDER_MBO_50_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(50);
    ...
    Order_MBO_50(char *buffer, const std::uint64_t bufferLength) :
        Order_MBO_50(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    Order_MBO_50(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        Order_MBO_50(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    Order_MBO_50 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    Order_MBO_50 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        Order_MBO_50 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    Order_MBO_50 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    Order_MBO_50 &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
    ...
    Order_MBO_50 &mDEntryType(const MDEntryType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
...
public:
    ...
    Order_MBO_50 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    Order_MBO_50 &mDEntryPositionNo(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    Order_MBO_50 &enteringFirm(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
public:
    ...
    {
        m_mDInsertTimestamp.wrap(m_buffer, m_offset + 36, m_actingVersion, m_bufferLength);
    ...
    Order_MBO_50 &secondaryOrderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    Order_MBO_50 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const Order_MBO_50 &_writer)
{
    Order_MBO_50 writer(
        _writer.m_buffer,
        _writer.m_offset,
