...
#ifndef _B3_UMDF_MBO_SBE_DELETEORDER_MBO_51_CXX_H_
#define _B3_UMDF_MBO_SBE_DELETEORDER_MBO_51_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(51);
    ...
    DeleteOrder_MBO_51(char *buffer, const std::uint64_t bufferLength) :
        DeleteOrder_MBO_51(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    DeleteOrder_MBO_51(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        DeleteOrder_MBO_51(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    DeleteOrder_MBO_51 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    DeleteOrder_MBO_51 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    DeleteOrder_MBO_51 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        DeleteOrder_MBO_51 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    DeleteOrder_MBO_51 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDUpdateAction::Value::DELETE;
    }
    ...
    {
        return static_cast<std::uint8_t>(MDUpdateAction::Value::DELETE);
    }
    ...
    DeleteOrder_MBO_51 &mDEntryType(const MDEntryType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    DeleteOrder_MBO_51 &mDEntryPositionNo(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    DeleteOrder_MBO_51 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    DeleteOrder_MBO_51 &secondaryOrderID(const std::uint64_t value) SBE_NOEXCEPT
    {
        std::uint64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 32, m_actingVersion, m_bufferLength);
    ...
    DeleteOrder_MBO_51 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const DeleteOrder_MBO_51 &_writer)
{
    DeleteOrder_MBO_51 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "DeleteOrder_MBO_51", )";
