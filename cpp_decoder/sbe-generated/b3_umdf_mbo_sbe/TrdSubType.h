...
public:
    ...
    static TrdSubType::Value get(const std::uint8_t value)
    {
        switch (value)
        {
            ...
            case static_cast<std::uint8_t>(105): return RF_TRADE;
            ...
            case static_cast<std::uint8_t>(109): return SWEEP_TRADE;
