...
#ifndef _B3_UMDF_MBO_SBE_FORWARDTRADE_54_CXX_H_
#define _B3_UMDF_MBO_SBE_FORWARDTRADE_54_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(68);
    ...
    ForwardTrade_54(char *buffer, const std::uint64_t bufferLength) :
        ForwardTrade_54(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ForwardTrade_54(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ForwardTrade_54(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ForwardTrade_54 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ForwardTrade_54 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        ForwardTrade_54 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ForwardTrade_54 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    ForwardTrade_54 &tradingSessionID(const TradingSessionID::Value value) SBE_NOEXCEPT
    {
...
public:
    ...
    ForwardTrade_54 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    ForwardTrade_54 &tradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    ForwardTrade_54 &mDEntryBuyer(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ForwardTrade_54 &mDEntrySeller(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ForwardTrade_54 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    ForwardTrade_54 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    ForwardTrade_54 &sellerDays(const std::uint16_t value) SBE_NOEXCEPT
    {
        std::uint16_t val = SBE_LITTLE_ENDIAN_ENCODE_16(value);
...
public:
    ...
    ForwardTrade_54 &trdSubType(const TrdSubType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ForwardTrade_54 &_writer)
{
    ForwardTrade_54 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ForwardTrade_54", )";
