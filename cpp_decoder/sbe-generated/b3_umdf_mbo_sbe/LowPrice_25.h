...
#ifndef _B3_UMDF_MBO_SBE_LOWPRICE_25_CXX_H_
#define _B3_UMDF_MBO_SBE_LOWPRICE_25_CXX_H_
...
public:
    ...
    LowPrice_25(char *buffer, const std::uint64_t bufferLength) :
        LowPrice_25(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    LowPrice_25(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        LowPrice_25(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    LowPrice_25 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    LowPrice_25 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        LowPrice_25 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    LowPrice_25 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    LowPrice_25 &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
    ...
    {
        return MDEntryType::Value::SESSION_LOW_PRICE;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::SESSION_LOW_PRICE);
    }
    ...
    LowPrice_25 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    LowPrice_25 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const LowPrice_25 &_writer)
{
    LowPrice_25 writer(
        _writer.m_buffer,
        _writer.m_offset,
