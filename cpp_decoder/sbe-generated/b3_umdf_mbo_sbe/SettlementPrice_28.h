...
#ifndef _B3_UMDF_MBO_SBE_SETTLEMENTPRICE_28_CXX_H_
#define _B3_UMDF_MBO_SBE_SETTLEMENTPRICE_28_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(28);
    ...
    SettlementPrice_28(char *buffer, const std::uint64_t bufferLength) :
        SettlementPrice_28(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    SettlementPrice_28(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        SettlementPrice_28(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    SettlementPrice_28 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    SettlementPrice_28 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    SettlementPrice_28 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        SettlementPrice_28 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    SettlementPrice_28 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDEntryType::Value::SETTLEMENT_PRICE;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::SETTLEMENT_PRICE);
    }
    ...
    SettlementPrice_28 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    SettlementPrice_28 &openCloseSettlFlag(const OpenCloseSettlFlag::Value value) SBE_NOEXCEPT
    {
    ...
    SettlementPrice_28 &priceType(const PriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::size_t settlPriceTypeEncodingLength() SBE_NOEXCEPT
    {
        return 1;
    }

    SBE_NODISCARD std::uint8_t settlPriceTypeRaw() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    SBE_NODISCARD SettlPriceType::Value settlPriceType() const
    {
        std::uint8_t val;
        std::memcpy(&val, m_buffer + m_offset + 30, sizeof(std::uint8_t));
        return SettlPriceType::get((val));
    }

    SettlementPrice_28 &settlPriceType(const SettlPriceType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 31, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    SettlementPrice_28 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 31, &val, sizeof(std::uint32_t));
        return *this;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const SettlementPrice_28 &_writer)
{
    SettlementPrice_28 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "SettlementPrice_28", )";
