...
#ifndef _B3_UMDF_MBO_SBE_OPENINTEREST_29_CXX_H_
#define _B3_UMDF_MBO_SBE_OPENINTEREST_29_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(29);
    ...
    OpenInterest_29(char *buffer, const std::uint64_t bufferLength) :
        OpenInterest_29(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OpenInterest_29(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OpenInterest_29(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    OpenInterest_29 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    OpenInterest_29 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        OpenInterest_29 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    OpenInterest_29 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDEntryType::Value::OPEN_INTEREST;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::OPEN_INTEREST);
    }
    ...
    OpenInterest_29 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    OpenInterest_29 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    OpenInterest_29 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OpenInterest_29 &_writer)
{
    OpenInterest_29 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "OpenInterest_29", )";
