...
#ifndef _B3_UMDF_MBO_SBE_PRICEBAND_22_CXX_H_
#define _B3_UMDF_MBO_SBE_PRICEBAND_22_CXX_H_
...
public:
    ...
    {
        PriceBand_22 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
