...
#ifndef _B3_UMDF_MBO_SBE_TRADE_53_CXX_H_
#define _B3_UMDF_MBO_SBE_TRADE_53_CXX_H_
...
public:
    ...
    Trade_53(char *buffer, const std::uint64_t bufferLength) :
        Trade_53(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    Trade_53(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        Trade_53(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    Trade_53 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    Trade_53 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        Trade_53 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    Trade_53 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    Trade_53 &tradingSessionID(const TradingSessionID::Value value) SBE_NOEXCEPT
    {
...
public:
    ...
    Trade_53 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    Trade_53 &tradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    Trade_53 &mDEntryBuyer(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    Trade_53 &mDEntrySeller(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
    ...
    Trade_53 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    Trade_53 &trdSubType(const TrdSubType::Value value) SBE_NOEXCEPT
    {
        std::uint8_t val = (value);
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 44, m_actingVersion, m_bufferLength);
    ...
    Trade_53 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const Trade_53 &_writer)
{
    Trade_53 writer(
        _writer.m_buffer,
        _writer.m_offset,
