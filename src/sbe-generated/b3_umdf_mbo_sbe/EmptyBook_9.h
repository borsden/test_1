...
#ifndef _B3_UMDF_MBO_SBE_EMPTYBOOK_9_CXX_H_
#define _B3_UMDF_MBO_SBE_EMPTYBOOK_9_CXX_H_
...
public:
    ...
    EmptyBook_9(char *buffer, const std::uint64_t bufferLength) :
        EmptyBook_9(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    EmptyBook_9(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        EmptyBook_9(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    EmptyBook_9 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    EmptyBook_9 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        EmptyBook_9 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    EmptyBook_9 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 12, m_actingVersion, m_bufferLength);
        return m_mDEntryTimestamp;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const EmptyBook_9 &_writer)
{
    EmptyBook_9 writer(
        _writer.m_buffer,
        _writer.m_offset,
