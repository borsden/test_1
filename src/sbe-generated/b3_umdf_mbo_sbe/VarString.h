...
#ifndef _B3_UMDF_MBO_SBE_VARSTRING_CXX_H_
#define _B3_UMDF_MBO_SBE_VARSTRING_CXX_H_
...
public:
    ...
    static SBE_CONSTEXPR std::uint16_t lengthNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT16;
    }

    static SBE_CONSTEXPR std::uint16_t lengthMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(0);
    }

    static SBE_CONSTEXPR std::uint16_t lengthMaxValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint16_t>(1400);
    }
    ...
    SBE_NODISCARD std::uint16_t length() const SBE_NOEXCEPT
    {
        std::uint16_t val;
    ...
    VarString &length(const std::uint16_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, VarString &writer)
{
    builder << '{';
    builder << R"("length": )";
