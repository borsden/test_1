...
#ifndef _B3_UMDF_MBO_SBE_SNAPSHOTFULLREFRESH_ORDERS_MBO_71_CXX_H_
#define _B3_UMDF_MBO_SBE_SNAPSHOTFULLREFRESH_ORDERS_MBO_71_CXX_H_
...
public:
    ...
    {
        SnapshotFullRefresh_Orders_MBO_71 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
