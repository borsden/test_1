...
#ifndef _B3_UMDF_MBO_SBE_SECURITYDEFINITION_12_CXX_H_
#define _B3_UMDF_MBO_SBE_SECURITYDEFINITION_12_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(230);
    ...
    {
        SecurityDefinition_12 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
