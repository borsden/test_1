...
#ifndef _B3_UMDF_MBO_SBE_EXECUTIONSTATISTICS_56_CXX_H_
#define _B3_UMDF_MBO_SBE_EXECUTIONSTATISTICS_56_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(52);
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(56);
    ...
    ExecutionStatistics_56() = default;
    ...
    ExecutionStatistics_56(char *buffer, const std::uint64_t bufferLength) :
        ExecutionStatistics_56(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionStatistics_56(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionStatistics_56(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ExecutionStatistics_56 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ExecutionStatistics_56 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ExecutionStatistics_56 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    ExecutionStatistics_56 &sbeRewind()
    {
    ...
    {
        ExecutionStatistics_56 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionStatistics_56 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDEntryType::Value::EXECUTION_STATISTICS;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::EXECUTION_STATISTICS);
    }
    ...
    ExecutionStatistics_56 &tradingSessionID(const TradingSessionID::Value value) SBE_NOEXCEPT
    {
    ...
    ExecutionStatistics_56 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::int64_t tradeVolumeNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t tradeVolumeMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t tradeVolumeMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t tradeVolumeEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t tradeVolume() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionStatistics_56 &tradeVolume(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *vwapPxMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t vwapPxId() SBE_NOEXCEPT
    {
        return 37778;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t vwapPxSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool vwapPxInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t vwapPxEncodingOffset() SBE_NOEXCEPT
    {
        return 20;
    }

private:
    PriceOptional m_vwapPx;

public:
    SBE_NODISCARD PriceOptional &vwapPx()
    {
        m_vwapPx.wrap(m_buffer, m_offset + 20, m_actingVersion, m_bufferLength);
        return m_vwapPx;
    }
...
private:
    PriceOffset8Optional m_netChgPrevDay;

public:
    SBE_NODISCARD PriceOffset8Optional &netChgPrevDay()
    {
        m_netChgPrevDay.wrap(m_buffer, m_offset + 28, m_actingVersion, m_bufferLength);
        return m_netChgPrevDay;
    }

    SBE_NODISCARD static const char *numberOfTradesMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t numberOfTradesSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool numberOfTradesInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t numberOfTradesEncodingOffset() SBE_NOEXCEPT
    {
        return 36;
    }
    ...
    SBE_NODISCARD std::uint32_t numberOfTrades() const SBE_NOEXCEPT
    {
        std::uint32_t val;
    ...
    ExecutionStatistics_56 &numberOfTrades(const std::uint32_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 40, m_actingVersion, m_bufferLength);
    ...
    {
        std::uint32_t val;
        std::memcpy(&val, m_buffer + m_offset + 48, sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(val);
    }

    ExecutionStatistics_56 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        std::memcpy(m_buffer + m_offset + 48, &val, sizeof(std::uint32_t));
        return *this;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionStatistics_56 &_writer)
{
    ExecutionStatistics_56 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionStatistics_56", )";
    ...
    builder << ", ";
    builder << R"("numberOfTrades": )";
    builder << +writer.numberOfTrades();
