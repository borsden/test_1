...
#ifndef _B3_UMDF_MBO_SBE_THEORETICALOPENINGPRICE_16_CXX_H_
#define _B3_UMDF_MBO_SBE_THEORETICALOPENINGPRICE_16_CXX_H_
...
class TheoreticalOpeningPrice_16
{
private:
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(16);
    ...
    TheoreticalOpeningPrice_16() = default;
    ...
    TheoreticalOpeningPrice_16(char *buffer, const std::uint64_t bufferLength) :
        TheoreticalOpeningPrice_16(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    TheoreticalOpeningPrice_16(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        TheoreticalOpeningPrice_16(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    TheoreticalOpeningPrice_16 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    TheoreticalOpeningPrice_16 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    TheoreticalOpeningPrice_16 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    TheoreticalOpeningPrice_16 &sbeRewind()
    {
    ...
    {
        TheoreticalOpeningPrice_16 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    TheoreticalOpeningPrice_16 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    TheoreticalOpeningPrice_16 &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
    ...
    {
        return MDEntryType::Value::OPENING_PRICE;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::OPENING_PRICE);
    }
    ...
    SBE_NODISCARD static SBE_CONSTEXPR OpenCloseSettlFlag::Value openCloseSettlFlagConstValue() SBE_NOEXCEPT
    {
        return OpenCloseSettlFlag::Value::THEORETICAL_PRICE;
    }
    ...
    {
        return static_cast<std::uint8_t>(OpenCloseSettlFlag::Value::THEORETICAL_PRICE);
    }
    ...
    TheoreticalOpeningPrice_16 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    TheoreticalOpeningPrice_16 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    TheoreticalOpeningPrice_16 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const TheoreticalOpeningPrice_16 &_writer)
{
    TheoreticalOpeningPrice_16 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "TheoreticalOpeningPrice_16", )";
