...
#ifndef _B3_UMDF_MBO_SBE_CHANNELRESET_11_CXX_H_
#define _B3_UMDF_MBO_SBE_CHANNELRESET_11_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(11);
    ...
    ChannelReset_11(char *buffer, const std::uint64_t bufferLength) :
        ChannelReset_11(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ChannelReset_11(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ChannelReset_11(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    ChannelReset_11 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ChannelReset_11 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        ChannelReset_11 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    {
        return MDEntryType::Value::EMPTY_BOOK;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::EMPTY_BOOK);
    }
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 4, m_actingVersion, m_bufferLength);
        return m_mDEntryTimestamp;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ChannelReset_11 &_writer)
{
    ChannelReset_11 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ChannelReset_11", )";
