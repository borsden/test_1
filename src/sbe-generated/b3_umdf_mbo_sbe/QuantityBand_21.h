...
#ifndef _B3_UMDF_MBO_SBE_QUANTITYBAND_21_CXX_H_
#define _B3_UMDF_MBO_SBE_QUANTITYBAND_21_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(40);
    ...
    QuantityBand_21(char *buffer, const std::uint64_t bufferLength) :
        QuantityBand_21(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    QuantityBand_21(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        QuantityBand_21(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    QuantityBand_21 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    QuantityBand_21 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        QuantityBand_21 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    QuantityBand_21 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDEntryType::Value::QUANTITY_BAND;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::QUANTITY_BAND);
    }

    SBE_NODISCARD static const char *avgDailyTradedQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t avgDailyTradedQtyId() SBE_NOEXCEPT
    {
        return 37003;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t avgDailyTradedQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool avgDailyTradedQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t avgDailyTradedQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 12;
    }

    static SBE_CONSTEXPR std::int64_t avgDailyTradedQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t avgDailyTradedQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t avgDailyTradedQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t avgDailyTradedQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t avgDailyTradedQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    QuantityBand_21 &avgDailyTradedQty(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    static SBE_CONSTEXPR std::int64_t maxTradeVolNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t maxTradeVolMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t maxTradeVolMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }
    ...
    SBE_NODISCARD std::int64_t maxTradeVol() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    QuantityBand_21 &maxTradeVol(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 28, m_actingVersion, m_bufferLength);
    ...
    QuantityBand_21 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const QuantityBand_21 &_writer)
{
    QuantityBand_21 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "QuantityBand_21", )";
    ...
    builder << ", ";
    builder << R"("avgDailyTradedQty": )";
    builder << +writer.avgDailyTradedQty();
