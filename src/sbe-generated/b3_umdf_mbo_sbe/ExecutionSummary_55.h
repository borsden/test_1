...
#ifndef _B3_UMDF_MBO_SBE_EXECUTIONSUMMARY_55_CXX_H_
#define _B3_UMDF_MBO_SBE_EXECUTIONSUMMARY_55_CXX_H_
...
public:
    static constexpr std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(64);
    ...
    static constexpr std::uint16_t SBE_SCHEMA_VERSION = static_cast<std::uint16_t>(9);
    static constexpr const char* SBE_SEMANTIC_VERSION = "1.8.0";
    ...
    ExecutionSummary_55(char *buffer, const std::uint64_t bufferLength) :
        ExecutionSummary_55(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    ExecutionSummary_55(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        ExecutionSummary_55(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    {
        return static_cast<std::uint16_t>(55);
    }
    ...
    ExecutionSummary_55 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    ExecutionSummary_55 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    ExecutionSummary_55 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    {
        ExecutionSummary_55 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    ExecutionSummary_55 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    {
        return MDEntryType::Value::EXECUTION_SUMMARY;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::EXECUTION_SUMMARY);
    }
    ...
    ExecutionSummary_55 &aggressorSide(const AggressorSide::Value value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        m_lastPx.wrap(m_buffer, m_offset + 12, m_actingVersion, m_bufferLength);
        return m_lastPx;
    }
    ...
    static SBE_CONSTEXPR std::int64_t fillQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t fillQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t fillQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }
    ...
    SBE_NODISCARD std::int64_t fillQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionSummary_55 &fillQty(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD static const char *tradedHiddenQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
    ...
    static SBE_CONSTEXPR std::uint16_t tradedHiddenQtyId() SBE_NOEXCEPT
    {
        return 37779;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t tradedHiddenQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool tradedHiddenQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t tradedHiddenQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 28;
    }

    static SBE_CONSTEXPR std::int64_t tradedHiddenQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t tradedHiddenQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t tradedHiddenQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t tradedHiddenQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t tradedHiddenQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionSummary_55 &tradedHiddenQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *cxlQtyMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "optional";
    ...
    static SBE_CONSTEXPR std::uint16_t cxlQtyId() SBE_NOEXCEPT
    {
        return 84;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t cxlQtySinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool cxlQtyInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t cxlQtyEncodingOffset() SBE_NOEXCEPT
    {
        return 36;
    }

    static SBE_CONSTEXPR std::int64_t cxlQtyNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_INT64;
    }

    static SBE_CONSTEXPR std::int64_t cxlQtyMinValue() SBE_NOEXCEPT
    {
        return INT64_C(-9223372036854775807);
    }

    static SBE_CONSTEXPR std::int64_t cxlQtyMaxValue() SBE_NOEXCEPT
    {
        return INT64_C(9223372036854775807);
    }

    static SBE_CONSTEXPR std::size_t cxlQtyEncodingLength() SBE_NOEXCEPT
    {
        return 8;
    }

    SBE_NODISCARD std::int64_t cxlQty() const SBE_NOEXCEPT
    {
        std::int64_t val;
    ...
    ExecutionSummary_55 &cxlQty(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
    ...
    SBE_NODISCARD static const char *aggressorTimeMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static SBE_CONSTEXPR std::uint16_t aggressorTimeId() SBE_NOEXCEPT
    {
        return 2445;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::uint64_t aggressorTimeSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    SBE_NODISCARD bool aggressorTimeInActingVersion() SBE_NOEXCEPT
    {
        return true;
    }

    SBE_NODISCARD static SBE_CONSTEXPR std::size_t aggressorTimeEncodingOffset() SBE_NOEXCEPT
    {
        return 44;
    }

private:
    UTCTimestampNanos m_aggressorTime;

public:
    SBE_NODISCARD UTCTimestampNanos &aggressorTime()
    {
        m_aggressorTime.wrap(m_buffer, m_offset + 44, m_actingVersion, m_bufferLength);
        return m_aggressorTime;
    }
    ...
    ExecutionSummary_55 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 56, m_actingVersion, m_bufferLength);
        return m_mDEntryTimestamp;
    }

template<typename CharT, typename Traits>
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const ExecutionSummary_55 &_writer)
{
    ExecutionSummary_55 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "ExecutionSummary_55", )";
    ...
    builder << ", ";
    builder << R"("tradedHiddenQty": )";
    builder << +writer.tradedHiddenQty();

    builder << ", ";
    builder << R"("cxlQty": )";
    builder << +writer.cxlQty();

    builder << ", ";
    builder << R"("aggressorTime": )";
    builder << writer.aggressorTime();
