...
#ifndef _B3_UMDF_MBO_SBE_MASSDELETEORDERS_MBO_52_CXX_H_
#define _B3_UMDF_MBO_SBE_MASSDELETEORDERS_MBO_52_CXX_H_
...
public:
    ...
    static constexpr std::uint16_t SBE_TEMPLATE_ID = static_cast<std::uint16_t>(52);
    ...
    MassDeleteOrders_MBO_52() = default;
    ...
    MassDeleteOrders_MBO_52(char *buffer, const std::uint64_t bufferLength) :
        MassDeleteOrders_MBO_52(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    MassDeleteOrders_MBO_52(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        MassDeleteOrders_MBO_52(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    MassDeleteOrders_MBO_52 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    MassDeleteOrders_MBO_52 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    MassDeleteOrders_MBO_52 &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    MassDeleteOrders_MBO_52 &sbeRewind()
    {
    ...
    {
        MassDeleteOrders_MBO_52 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    MassDeleteOrders_MBO_52 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    MassDeleteOrders_MBO_52 &mDUpdateAction(const MDUpdateAction::Value value) SBE_NOEXCEPT
    {
    ...
    MassDeleteOrders_MBO_52 &mDEntryType(const MDEntryType::Value value) SBE_NOEXCEPT
    {
        char val = (value);
    ...
    MassDeleteOrders_MBO_52 &mDEntryPositionNo(const std::uint32_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        m_mDEntryTimestamp.wrap(m_buffer, m_offset + 16, m_actingVersion, m_bufferLength);
    ...
    MassDeleteOrders_MBO_52 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const MassDeleteOrders_MBO_52 &_writer)
{
    MassDeleteOrders_MBO_52 writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "MassDeleteOrders_MBO_52", )";
