...
#ifndef _B3_UMDF_MBO_SBE_TRADEBUST_57_CXX_H_
#define _B3_UMDF_MBO_SBE_TRADEBUST_57_CXX_H_
...
public:
    ...
    TradeBust_57(char *buffer, const std::uint64_t bufferLength) :
        TradeBust_57(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    TradeBust_57(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        TradeBust_57(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    TradeBust_57 &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    TradeBust_57 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    {
        TradeBust_57 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
    ...
    TradeBust_57 &securityID(const std::uint64_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    {
        return MDEntryType::Value::TRADE_BUST;
    }
    ...
    {
        return static_cast<char>(MDEntryType::Value::TRADE_BUST);
    }
    ...
    TradeBust_57 &tradingSessionID(const TradingSessionID::Value value) SBE_NOEXCEPT
    {
...
public:
    ...
    TradeBust_57 &mDEntrySize(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    TradeBust_57 &tradeID(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    TradeBust_57 &tradeDate(const std::uint16_t value) SBE_NOEXCEPT
    {
...
public:
    ...
    TradeBust_57 &rptSeq(const std::uint32_t value) SBE_NOEXCEPT
    {
        std::uint32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const TradeBust_57 &_writer)
{
    TradeBust_57 writer(
        _writer.m_buffer,
        _writer.m_offset,
